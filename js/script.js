const translations = {
    ua: {
        ...
        summary: "Вітаю! Після короткого, але насиченого досвіду в управлінні продуктом та взаємодії з клієнтами я прийняла рішення поринути в світ веб-розробки в ролі Frontend розробниці. Мої навички в оптимізації процесів та спілкуванні з клієнтами стануть міцним фундаментом для розвитку в новій сфері. Готова до нових викликів, відкрита для навчання і з нетерпінням чекаю можливості внести свій внесок у проекти в області веб-розробки.",
        city: "Київ, Україна",
        dates: {
    ...
    en:{
        ...
        summary: "Hi there! After a short but rich experience in product management and customer interaction, I have decided to immerse myself in the world of web development as a Frontend Developer. My skills in process optimization and communication with clients will serve as a solid foundation for development in this new field. I am ready for challenges, open to learning, and eagerly await the opportunity to contribute to projects in the web development area.",
        city: "Kyiv, Ukraine",
        dates: {
